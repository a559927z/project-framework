 ...
 * Generated at: 2017-07-18 11:47:21 UTC
...
public final class gridDemo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// Object version=request.getAttribute("version");
    ...
    if (request.getAttribute("versionJson") != null) {
      ...
      out.write("</div>\r\n");
      out.write("<script>\r\n");
      out.write("require(['jgGrid'],function(){\r\n");
      ...
      out.write("\t\tcolNames:['ID','Last Sales','Name', 'Stock', 'Ship via','Notes','operator'],\r\n");
      out.write("\t\tcolModel:[\r\n");
      ...
      out.write("\t\t\t{name:'note',index:'note', width:100, sortable:false,editable: true,edittype:\"textarea\", editoptions:{rows:\"2\",cols:\"10\"}},\r\n");
      out.write("\t\t\t{name:'myac',index:'', width:130, fixed:true, sortable:false, resize:false,\r\n");
