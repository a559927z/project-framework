 ...
 * Generated at: 2017-11-06 06:54:27 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.biz.admin.function;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class function_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// Object version=request.getAttribute("version");
    ...
    if (request.getAttribute("versionJson") != null) {
      ...
      out.write("\t\t\t\t<div class=\"index-common-title-text bottom-text\">功能界面</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"bottom-div clearfix\">\r\n");
      out.write("\t\t\t\t<div class=\"col-sm-12 ct-col2\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn btn-info\" id=\"addParentFunctionBtn\">添加根节点</button>\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- 功能(Modal) -->\r\n");
      out.write("\t<div class=\"modal fade\" id=\"functionModal\" tabindex=\"-1\" role=\"dialog\"\r\n");
      out.write("\t\t aria-labelledby=\"functionModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t\t<form id=\"functionFrom\" name=\"functionFrom\" class=\"form-horizontal\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/function/editFunction\" method=\"post\">\r\n");
      out.write("\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\"\r\n");
      out.write("\t\t\t\t\t\t\taria-hidden=\"true\">×</button>\r\n");
      out.write("\t\t\t\t\t<h3 class=\"modal-title\" id=\"functionModalLabel\">添加功能<input type=\"hidden\" name=\"functionId\"></h3>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">功能编码</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"functionKey\" placeholder=\"请输入功能编码\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">功能名称</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"functionName\" placeholder=\"请输入功能名称\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\" id=\"parentFunctionGroup\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">上级功能</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"functionParentName\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control\"  id=\"functionParentKey\" name=\"pKey\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control\" id=\"functionParentId\" name=\"pid\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control\" id=\"functionParentTreeId\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\" id=\"isMenuGroup\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">是否菜单栏</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"radio-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"isMenu\" type=\"radio\" value=\"1\" class=\"ace\" checked=\"checked\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"lbl\">是</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"radio-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"isMenu\" type=\"radio\" value=\"0\" class=\"ace\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"lbl\">否</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group hide\" id=\"urlGroup\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">功能链接</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"url\" placeholder=\"请输入功能链接\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">功能排序</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"number\" class=\"form-control\" name=\"showIndex\" placeholder=\"请输入功能排序\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">功能描述</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea name=\"note\" rows=\"3\" class=\"form-control\" placeholder=\"请输入功能描述\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t</div><!-- /.modal -->\r\n");
      out.write("\r\n");
      out.write("\t<!-- 功能操作(Modal) -->\r\n");
      out.write("\t<div class=\"modal fade\" id=\"itemModal\" tabindex=\"-1\" role=\"dialog\"\r\n");
      out.write("\t\t aria-labelledby=\"itemModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" id=\"itemParentTreeId\">\r\n");
      out.write("\t\t\t<form id=\"itemFrom\" name=\"itemFrom\" class=\"form-horizontal\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/function/editFunctionItem\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\"\r\n");
      out.write("\t\t\t\t\t\t\t\taria-hidden=\"true\">×</button>\r\n");
      out.write("\t\t\t\t\t\t<h3 class=\"modal-title\" id=\"itemModalLabel\">添加功能操作<input type=\"hidden\" name=\"functionItemId\"></h3>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\">操作说明</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"note\" class=\"form-control\" placeholder=\"请输入操作说明\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\">操作项</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"itemCode\" placeholder=\"请输入操作项\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\">所属功能</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"functionName\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"functionId\" name=\"functionId\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-footer\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- 删除（Modal） -->\r\n");
      out.write("\t<div class=\"modal fade\" id=\"removeModal\" tabindex=\"-1\" role=\"dialog\"\r\n");
      out.write("\t\t aria-labelledby=\"removeModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\r\n");
      out.write("\t\t\t\t\t\t<h3 class=\"modal-title\" id=\"removeModalLabel\">警告</h3>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">是否确定删除？</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-footer\">\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" id=\"removeSubmitBtn\" class=\"btn btn-primary\">确定</button>\r\n");
      ...
      out.write("\t<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/assets/js/biz/admin/functionList.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
