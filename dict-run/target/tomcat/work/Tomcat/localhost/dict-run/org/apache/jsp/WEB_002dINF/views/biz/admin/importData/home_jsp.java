 ...
 * Generated at: 2017-07-26 09:51:24 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.biz.admin.importData;
...
// Object version=request.getAttribute("version");
    ...
    if (request.getAttribute("versionJson") != null) {
      ...
      out.write("\t\t\t\t<div class=\"index-common-title-text bottom-text\">数据导入管理</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"bottom-div clearfix\">\r\n");
      out.write("\t\t\t\t<div class=\"col-sm-12 ct-col2\">\r\n");
      out.write("\t\t\t\t\t<div class=\"alert alert-info\">\r\n");
      out.write("\t\t\t\t\t\t<i class=\"icon-hand-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t在这里您可以选择需要导入的 <code>Excel数据模板</code>。这有助于我们更准确验证您的Excel结构是否合适。\r\n");
      out.write("\t\t\t\t\t\t");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<div class=\"importData-warp\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-12 ct-col1 ct-col2\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel panel-default\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<form action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/importData/doImportExcel\" class=\"form-group\" id=\"importForm\" name=\"importForm\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  role=\"form\" enctype=\"multipart/form-data\" method=\"post\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12 col-xs-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"checkbox-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"type\" class=\"form-field-checkbox\" value=\"organ\" aria-label=\"...\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span> 机构树</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"checkbox-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"type\" class=\"form-field-checkbox\" value=\"user\" aria-label=\"...\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span> 用户</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"checkbox-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"type\" class=\"form-field-checkbox\" value=\"emp\" aria-label=\"...\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span> 员工</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"checkbox-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"type\" class=\"form-field-checkbox\" value=\"role\" aria-label=\"...\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" name=\"inputfile\" id=\"inputfile\" class=\"fallback\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12 col-xs-12\">\r\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/assets/js/biz/admin/importData.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
