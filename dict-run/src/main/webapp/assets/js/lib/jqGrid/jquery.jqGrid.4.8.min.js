...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		//edit by jayu 添加自定义属性
		var customClass =$(this).attr('class');
		var eg = $("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all " + customClass + "'></div>");
...
$.jgrid.extend({
	...
	setGridWidth : function(nwidth, shrink) {
		return this.each(function(){
			...
			//edit by jayu 在谷歌浏览器下会出现横向滚动条，故把整体宽度+1px,用于去掉滚动条
