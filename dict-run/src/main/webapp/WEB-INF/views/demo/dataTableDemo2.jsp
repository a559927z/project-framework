...
<%@include file="/WEB-INF/views/include/top.jsp"%>
    ...
    <meta charset="utf-8"/>
 	<link rel="stylesheet" type="text/css" href="${ctxAssets}plugin/datatables/jquery.dataTables.css">

</head>
<body>
		<div>
			是否自动检索：<input type="checkbox" id="autoSearch"> <br> 姓名：<input
				type="text" class="form-controlSearch" placeholder="请输入关键字查询"
				data-column="1" id="col1_filter"> <br> 地点：<input
				type="text" class="form-controlSearch" placeholder="请输入关键字查询"
				data-column="2" id="col2_filter"> <br> 薪水：<input
				type="text" class="form-controlSearch" placeholder="请输入关键字查询"
				data-column="3" id="col3_filter"> <br> 入职时间：<input
				type="text" class="form-controlSearch" placeholder="请输入关键字查询"
				data-column="4" id="col4_filter"> <br> 办公地点：<input
				type="text" class="form-controlSearch" placeholder="请输入关键字查询"
				data-column="5" id="col5_filter"> <br> 编号：<input
				type="text" class="form-controlSearch" placeholder="请输入关键字查询"
				data-column="6" id="col6_filter"> <br>
			<hr>
...
<script>
    ...
    //路径配置
    employee.url="${ctxAssets}plugin/datatables/";
    employee.requestUrl = {
        queryList:employee.url+"objects.txt"
    };
    employee.search={
        uuid:""
    };
