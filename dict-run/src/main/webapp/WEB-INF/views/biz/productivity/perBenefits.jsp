				...
				<div class="col-md-12 ct-line-col SetUpBody" view="chart">
					...
					<div class="bottom-div clearfix">
						<div class="chart-view">
							<div class="col-xs-12 ct-col2" id="benefitTrendMonth">
								<div class="col-sm-8 col-xs-12 ct-col1"  view="chart">

									<div class="index-common-title bottom-title">
										<div class="rightSetUpBtn">
											<div class="rightSetUpBtnDiv rightSetUpLeft icon rightSetUpBtnSelect" data-key="profit">
												<div class="rightSetUpBtnTop"></div>
												<div class="rightSetUpLeftShowIcon"></div>
												<div class="rightSetUpLeftHideIcon"></div>
											</div>
											<div class="rightSetUpBtnDiv rightSetUpRight icon" data-key="profit">
												<div class="rightSetUpBtnTop"></div>
									...
									<div class="bottom-div height450">
										<div class="chart-view">
									...
									<div class="bottom-div height450">
										...
										<div class="table-view">
											...
											<div class="data hide" id="profitYear">
												<table class="table" id="profitYearGrid"></table>
											</div>
										</div>
									</div>
			...
			<div class="row ct-row">
				...
				<div class="col-sm-8 ct-line-col SetUpBody" view="chart">
					<div class="index-common-title bottom-title">
                        ...
                        <div class="rightSetUpBtn">
                            <div class="rightSetUpBtnDiv rightSetUpLeft icon rightSetUpBtnSelect" data-key="orgBenefit">
                                <div class="rightSetUpBtnTop"></div>
                                <div class="rightSetUpLeftShowIcon"></div>
                                <div class="rightSetUpLeftHideIcon"></div>
                            </div>
                            <div class="rightSetUpBtnDiv rightSetUpRight icon" data-key="orgBenefit">
                                <div class="rightSetUpBtnTop"></div>
                                <div class="rightSetUpRightShowIcon"></div>
                                <div class="rightSetUpRightHideIcon"></div>
                            </div>
					...
					<div class="bottom-div">
						<div class="chart-view">
							<div class="col-xs-12 padding0">
								<div class="col-sm-8 col-xs-12 padding0 height450">
						...
						<div class="table-view">
							<div class="col-xs-12 padding0 height350">
								...
								<div class="data height350 hide" id="orgBenefit">
									<table  class="table" id="orgBenefitGrid"></table>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-4 ct-line-col SetUpBody" view="chart">
					...
					<div class="bottom-div clearfix padding5">
						<div class="chart-view">
							<div class="col-xs-12 padding0 height320">
								<div class="data loadingmessage">数据加载中</div>
								<div class="data height320 hide" id="fteChart"></div>
							</div>
						</div>
					</div>
				</div>
