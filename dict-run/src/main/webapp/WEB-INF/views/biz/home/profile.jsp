...
<title>用户平台</title>
 <link rel="stylesheet" href="${ctx}/assets/plugin/xEditable/bootstrap-editable.css" /> 
...
<body>
			<!-- <a href="#" id="abc">superuser</a> -->
		 

       	<!-- <img id="uploadImage" src="http://www.firefox.com.cn/favicon.ico"> -->
		<input type="file" id="myBlogImage" name="myfiles" style="display: none;" />
		 <!-- <input type="button" id="ajaxFileUpload" value="上传图片" />  -->


<%-- 	${organPermitTopDtos.get(0).organizationName } --%>
<%-- 	${organPermitTopDtos.get(1).organizationName }, --%>
					...
					<div id="user-profile-1" class="user-profile row">
						<div class="col-xs-12 col-sm-3 center">
							<div>
								<span class="profile-picture">
									<!-- src="${ctx }/assets/img/avatars/profile-pic.jpg" -->
									<img id="avatar" class="editable img-responsive editable-click editable-empty" alt="Alex's Avatar" style="width:190px; height:200px;"
										 src=""> 
									<span id="changAvatar"  style="display: none; "  class="editable-container editable-inline ">
										<div>
											<div class="editableform-loading" style="display: none;"><i class="light-blue icon-2x icon-spinner icon-spin"></i></div>
											<!-- <form class="form-inline editableform" > -->
												<div class="control-group" style="width: 190px; ">
													<div>
														<div class="">
															<!-- <span><input type="hidden" name="avatar-hidden" value=""></span> -->
															<span>
																<div id="popupFiledielog" class="ace-file-input ace-file-multiple" style="">
														...
														<div class="editable-buttons">
															<button id="ajaxFileUploadBtn" type="" class="btn btn-info editable-submit"><i class="icon-ok icon-white"></i></button>
															<button id="cancelBtn" type="" class="btn editable-cancel"><i class="icon-remove"></i></button>
														</div>
													</div>
								...
								<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
									<div class="inline position-relative">
										<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
											...
											&nbsp;
											<span class="white" id="userKey"></span>
										</a>
						...
						<div class="col-xs-12 col-sm-9">
							...
							<div class="profile-user-info profile-user-info-striped">
								...
								<div class="profile-info-row">
									<div class="profile-info-name"> 加入组织日期 </div>
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable editable-click" id="login"></span>
									</div>
								</div>
							...
							<div class="widget-box transparent">
								...
								<div class="widget-body">
									<div class="widget-main padding-8">
										...
										</div><div class="slimScrollBar ui-draggable" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 99.0491px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
									</div>
								</div>
							</div>
							...
							<div class="tab-content no-border padding-24">
								<div id="home" class="tab-pane in active">
									<div class="row">
										<div class="col-xs-12 col-sm-3 center">
											<span class="profile-picture">
												<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2"src="${ctx}/assets/avatars/profile-pic.jpg">
											</span>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-user-info">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<a href="#" target="_blank">www.superAdmin.com</a>
													</div>
												</div>
									...
									<div class="profile-users clearfix">
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar4.png" alt="Bob Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar1.png" alt="Rose Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar.png" alt="Jim Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar5.png" alt="Alex Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar2.png" alt="Phil Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar3.png" alt="Susan Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar1.png" alt="Jennifer Doe's avatar">
													</a>
												</div>
										...
										<div class="itemdiv memberdiv">
											<div class="inline position-relative">
												<div class="user">
													<a href="#">
														<imgsrc="${ctx}/assets/avatars/avatar3.png" alt="Alexa Doe's avatar">
													</a>
												</div>
									...
									<div class="tab-content profile-edit-tab-content">
										<div id="edit-basic" class="tab-pane active">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<span class="input-icon input-icon-right">
														<input type="url" id="form-field-website" value="http://www.superAdmin.com/">
	...
	<script src="${ctx}/assets/js/biz/home/profile.js"></script>
</body>
</html>
