...
<head>
    ...
    <title>人员对比</title>
    <link rel="stylesheet" href="${ctx}/assets/css/biz/employee/talentContrast2.css"/>
</head>
<body>
        ...
        <div class="row ct-row" id="accordion">
            <div class="col-xs-12 ct-col1 ct-col-contrast">
                ...
                <table class="contrast-table" id="collapseThree">
                    <tr>
                        <td class="contrast-td-one">绩效轨迹<input type="hidden" value="${performanceStr}" id="performanceStr"></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <%--<div class="modal-footer">--%>
                    <%--<div id="addPackSubmitButton" class="modal-btn success-btn">确定</div>--%>
...
<script src="${jsRoot}biz/employee/talentContrast2.js"></script>
</body>
</html>