...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/assets/css/biz/lineHome.css"/>
</head>
<body>
<div class="container-fluid ct-container-fluid ct-ancestors index">
    ...
    <div class="index-jy-body">
        ...
        <div name="预警" class="row ct-row index-jy-middle">
            ...
            <%--<div name="低绩效未调整" aria-controls="performanceWarnTab" showIndex="3" class="DRAG-DIV YJ-DIV col-sm-3 ct-col1 index-yj-div">--%>
                ...
                <%--<div class="index-yj-div-bottom">--%>
                    <%--<div id="performanceLowWarnTabDiv" class="index-yj-div-bottom-value left"></div>--%>
                    <%--<div class="index-yj-div-bottom-right right"></div>--%>
                <%--</div>--%>
            <%--</div>--%>
            ...
            <div name="工作生活平衡欠佳" aria-controls="workLifeWarnTab" showIndex="4" class="DRAG-DIV YJ-DIV col-sm-3 ct-col1 index-yj-div">
                ...
                <%--<div class="index-yj-div-bottom">--%>
                    <%--<div id="workLifeWarnTabDiv" class="index-yj-div-bottom-value left"></div>--%>
                    <%--<div class="index-yj-div-bottom-right right"></div>--%>
                <%--</div>--%>
            </div>
        </div>
    ...
    <div name="首页" class="row ct-row">
        ...
        <div name="项目人力盘点" showIndex="4" class="DRAG-DIV col-sm-6 ct-col">
            <div class="index-son-body">
                <div class="index-common-title">
                    <div class="index-common-title-left"></div>
                    <div class="index-common-title-text">项目人力盘点</div>
                </div>
                <div class="index-son-middle">
                    <div class="col-xs-12 ct-col1 index-yj-div">
                        <img src="${ctx}/assets/img/temp/talent-checking.png" style="width: 100%;height: 100%" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div name="员工管理" showIndex="7" class="DRAG-DIV col-sm-6 ct-col">
            <div class="index-son-body">
                <div class="index-common-title">
                    <div class="index-common-title-left"></div>
        ...
        <div name="关键人才库" showIndex="8" class="DRAG-DIV col-sm-6 ct-col">
            <div class="index-son-body">
                <div class="index-common-title">
                    <div class="index-common-title-left"></div>
...
<script src="${ctx}/assets/js/biz/lineHome.js"></script>
</body>
</html>