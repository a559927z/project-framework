...
public interface OrganDao {
	 ...
	 * @return
	 */
	List<TreeDto> queryOrganTree(@Param("userId") String userId, @Param("customerId") String customerId);
	 ...
	 * @return
	 */
	List<OrganDto> queryRoleOrgans(@Param("roleId") String roleId, @Param("customerId") String customerId,
	 ...
	 * @param roleId
	 */
	void deleteRoleOrganization(@Param("roleId") String roleId, @Param("customerId") String customerId);
	 ...
	 * @return
	 */
	List<TreeDto> querySubOrganAsync(@Param("parentId") String parentId, @Param("customerId") String customerId,
	 ...
	 * @return
	 */
	Integer getEmpCountByOrganId(@Param("customerId") String customerId,
			@Param("organizationId") String organizationId);
	 ...
	 * @return
	 */
	// List<OrganDto> queryOrganPermitTop(@Param("userId") String userId,
	 ...
	 * @return
	 */
	List<OrganDto> queryDirectOrgans(@Param("customerId") String customerId, @Param("orgPid") String orgPid,
			@Param("isShowSelf") boolean isShowSelf);
	 ...
	 * @return
	 */
	List<String> queryOrgansByPid(@Param("customerId") String customerId, @Param("orgPid") String orgPid,
			@Param("isHideSelf") boolean isHideSelf);
