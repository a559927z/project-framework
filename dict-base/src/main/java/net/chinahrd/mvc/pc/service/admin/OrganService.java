...
public interface OrganService {
	 ...
	 * @return
	 */
	List<TreeDto> queryOrganTree(String userId, String customerId, Boolean isSingleOrgan);
	 ...
	 * @return
	 */
	List<OrganDto> queryRoleOrgans(String roleId, String customerId, Boolean isOrganPermit);
	 ...
	 * @return TODO
	 */
	boolean addRoleOrganization(String roleId, String createUserId, String customerId, List<OrganDto> organDtos);
	 ...
	 * @return
	 */
	List<UserDto> queryEmpsByOrganId(String customerId, @Param("organizationId") String organizationId);
