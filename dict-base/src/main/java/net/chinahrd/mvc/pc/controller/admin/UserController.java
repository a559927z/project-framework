...
public class UserController extends BaseController {
    ...
    public boolean updateUserPWDbyUserName(@RequestParam("passwd") String inputPwd, @RequestParam("userName") String userName){
    	String enPwd = "";
    	String defaultPWD = PropertiesUtil.getProperty("user.password").trim();
    	if(defaultPWD.equals(inputPwd)){enPwd = defaultPWD;}
    	else{
        	String keyPwd =  inputPwd + StringUtils.substring(EisWebContext.getCurrentUser().getUserKey(), 1, 2);
    ...
    public ResultDto<String> addUserRoles(
