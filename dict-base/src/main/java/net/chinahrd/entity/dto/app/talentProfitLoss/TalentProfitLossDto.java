 ...
 */
public class TalentProfitLossDto implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1648637078016214803L;
	private String flag;// 标识
	private String sumName;// 统计人名
	...
	private String changeTypeName;// 异动类型
	private String changeDate;// 异动日期
	private Integer conNum;// 数量
	private String curtName;// 异动类型简称
	private String sequenceName;// 序列名称
	private String abilityName;// 职级名称
	private Integer age;// 年龄
	private String populationId; // 人群id
	private String populationName;// 人群名称
