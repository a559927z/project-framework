...
//	private static final Logger log = Logger.getLogger(JobManagerCenter.class);
...
//	 * @return
//	 */
//	private static JobRegister getApiDoc(String moduleName) {
...
//		JobRegister apiModel=getApiDoc(moduleName);
//		if(null!=apiModel){
//			return (T)apiModel;
//		}
//		return null;
