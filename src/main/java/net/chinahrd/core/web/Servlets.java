...
import net.chinahrd.core.tools.Encodes;
...
public class Servlets {
	...
	/**
	 * Differentiate Ajax requests from normal Http requests
	 * X-Requested-With请求头用于在服务器端判断request来自Ajax请求还是传统请求。
	 * 
	 * @param req
	 *            HttpServletRequest
	 * @return true if the request have X-Requested-With: XMLHttpRequest request
	 *         header.
	 */
	...
	/**
	 * Get domain URL with application name (actually the context path)
	 * 
	 * <pre>
	 * https://www.mywebsite.com:8080/MyWebApp/protected/index.jsp 
	 * to
	 * https://www.mywebsite.com:8080/MyWebApp
	 * </pre>
	 * 
	 * @param req
	 *            HttpServletRequest
	 * @return domain URL with context path
	 */
	public static String getBaseUrl(HttpServletRequest req) {
		Validate.notNull(req);

		StringBuilder path = new StringBuilder();
		path.append(req.getScheme()).append("://");
		path.append(req.getServerName()).append(":");
