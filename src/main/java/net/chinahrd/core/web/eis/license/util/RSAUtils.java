//package org.apache.cloudstack.license.util;
//
...
public class RSAUtils {
    ...
    public static Map<String, Object> createKeyPairs() throws Exception {
...
//        String strpk = new String(Base64Utils.encode(pk));
//        String strprivk = new String(Base64Utils.encode(privk));
//
...
//
//        X509EncodedKeySpec pubX509 = new X509EncodedKeySpec(Base64Utils.decode(strpk));
//        PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(Base64Utils.decode(strprivk));
//
...
//        System.out.println(privKey.equals(privkey2));
    ...
    public static void main(String args[]){
    	try {
			Map<String,Object> keymap = RSAUtils.createKeyPairs();
