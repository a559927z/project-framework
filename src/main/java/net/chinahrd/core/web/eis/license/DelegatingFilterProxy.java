...
//		String licensePath=hsr.getContextPath()+"/license/page";
//		boolean b=false;
//		if(url.equals(licensePath)){
//			b=true;
//		}else if(url.endsWith("/error/license.jsp")){
//			Object obj=hsr.getAttribute("license");
//			if(obj!=null){
//				b=true;
//			}
//		}
//		if(!b&&!License.getInstance().getLicenseData().getValid()){
//			hsr.getRequestDispatcher("/license/page").forward(request, response);
//		}else{
